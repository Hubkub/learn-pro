...
import com.java.base.reflex.Person;
...
//        }
    ...
    private void generic(){
        List<Person> personList = new ArrayList<Person>(){{
            this.add(new Person("aa", 1, "01-01"));
            this.add(new Person("bb", 12, "03-01"));
            this.add(new Person("cc", 7, "04-01"));
            this.add(new Person("dd", 6, "02-01"));
        }};
